  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative px-4 sm:px-6 py-20 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle, #0D1A0D 1px, transparent 1px)",
      ...
      {/* Floating Elements */}
      <div
        className="absolute top-1/4 left-10 w-16 h-16 rounded-2xl bg-ani-green/10 animate-bounce-subtle hidden lg:block"
        style={{ animationDelay: "0.5s" }}
      />
      <div
        className="absolute top-1/3 right-16 w-12 h-12 rounded-xl bg-ani-green/15 animate-bounce-subtle hidden lg:block"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute bottom-1/4 left-1/4 w-8 h-8 rounded-lg bg-ani-green/20 animate-bounce-subtle hidden lg:block"
